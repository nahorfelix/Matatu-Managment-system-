...
$sql = "SELECT m.registration_number AS matatu_name, SUM(b.payment_amount) as total_revenue
        FROM matatus m
...
$sql_bookings = "SELECT b.passenger_name, b.route, b.payment_amount, m.registration_number as matatu_name
                 FROM bookings b
...
<body>
    ...
    <div class="container">
        <h4 class="center-align text-light">User Dashboard</h4>
        ...
        <!-- Revenue Per Matatu -->
        <h5 class="text-light">Matatu Revenue Summary</h5>
        <table class="striped">
            <thead>
                <tr>
                    <th>Matatu</th>
        ...
        <!-- Booking Details -->
        <h5 class="text-light">All Booking Details</h5>
        <table class="striped">
            <thead>
                <tr>
